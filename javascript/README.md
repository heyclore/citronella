...
| locate             | by          | -                | similar as`driver.findElement` as input & return [citronella.WebUi](https://github.com/heyclore/citronella/tree/main/javascript#citronellaui--citronellawebui) object |
